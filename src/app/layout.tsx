  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="psicologos-logopedia-y";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Psicólogos, Logopedia y Psicopedagogía Essential Mora"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="psicologos-logopedia-y"
          data-primary-color="#06adb6"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="psicologos-logopedia-y";
